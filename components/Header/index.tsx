...
import {
  ...
  SUBMIT_ENTRY_ONLINE_BATTLE_BUTTON,
} from "util/constants";
...
const modalCta = [
  ...
  {
    id: 3,
    name: "Submit your Online Battle entry",
    type: SUBMIT_ENTRY_ONLINE_BATTLE_BUTTON,
  },
];
...
export default function Header({
  ...
  const closeModal = () => {
    ...
    dispatch(chooseModal({ modalChosen: "" }));
  };
        ...
        >
          {(() => {
            switch (modalClicked) {
              ...
              case SUBMIT_ENTRY_ONLINE_BATTLE_BUTTON:
